...
- **Svg / LinguistTools introuvable** : `qtsvg` et `qttools` sont des archives de base du kit desktop aqt (Qt 6.9+). Ne pas les passer en `-m` : aqt échoue (`packages were not found`).
